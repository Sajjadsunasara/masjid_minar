  ...
  return (
    <>
        <header className="bg-white sticky top-0">
            ...
            <div className="flex items-center justify-between">
                ...
                <img
                    ...
                    src="images/HARMAIN-MINAR-LOGO.jpg"
                    alt=""
                />
                </a>
                <button
      ...
      <main>
        ...
        <section>
          <div className="bg-[#F3F7F7] py-12 px-6 sm:px-16 lg:px-24">
            <div className="lg:flex flex-wrap justify-between items-center">
              <div className="lg:w-8/12">
                ...
                <p className="text-[#666666] mt-5">
                  We are the Best RCC Minar Manufacturer, Readymade Masjid
                  Minar, RCC Mimber, Marble Mimber and Wuzu Stand, Parapet
                  Boundry Wall, etc.
                </p>
              </div>
              <div>
                <button
                  type="button"
                  className="bg-[#F0E033] hover:bg-[#facc15] mt-6 lg:mt-0 px-6 py-2 font-semibold rounded"
                >
                  View All Product
                </button>
              </div>
            ...
            <div className="mt-10 sm:grid grid-cols-2 gap-5 lg:flex justify-between">
              <img
                className="w-full lg:w-1/5 rounded-2xl"
                src={require("../../images//product-1.jpg")}
                alt="RCC Minar Product"
              />
              <img
                className="mt-5 sm:mt-0 lg:w-1/5 rounded-2xl"
                src={require("../../images//product-2.jpg")}
                alt="Marble Mimber Product"
              />
              <img
                className="mt-5 sm:mt-0 lg:w-1/5 rounded-2xl"
        ...
        <section>
          <div
            ...
            className=" bg-cover py-12 px-6 sm:px-16 lg:px-24 text-center"
          >
