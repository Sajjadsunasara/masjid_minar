...
const Category = () => {
  ...
  return (
    <>
      ...
      <section>
        <div className="bg-[#FCFCFC] py-12 px-6 sm:px-16 lg:px-24 lg:flex flex-wrap justify-between items-center">
          <div className="lg:w-2/5">
            <img
              src={require("../../images/intro-img.png")}
              alt="RCC Minar by Harmain Traders"
            />
          </div>
          <div className="lg:w-2/4 mt-6 lg:mt-0">
            <h1 className="text-4xl">
              <strong className="text-[#008080]">Harmain Traders |</strong>
              <br />
              Leading RCC Minar Manufacturer.
            </h1>
            <p className="mt-5 text-[#666666]">
              <strong className="text-[#008080]">
                Harmain Precast Industries
              </strong>{" "}
              is a leading RCC Minar Manufacturer, providing Readymade Masjid
              Minar, <strong className="text-[#008080]">RCC Minar</strong> all
              over India including Gujarat and Maharashtra. Harmain Minar,
              having its presence in RCC Minar construction and concrete minar
              product manufacturing, was established in 1983 by concrete
              technologists with a mission to provide environment-friendly
              solutions.
            </p>
            <p className="mt-4 text-[#666666]">
              Our main goal is to provide good quality and strong{" "}
              <strong className="text-[#008080]">RCC Masjid Minar</strong> and
              RCC construction services and concrete products. Our focus is to
              provide high-quality, well-finished material and ensure timely
              completion of projects.
            </p>
            <button className="bg-[#F0E033] hover:bg-[#facc15] mt-6 px-6 py-2 font-semibold rounded">
              Learn More About
            </button>
          </div>
        </div>
      ...
      <main>
        <div className="bg-[#c8cbcf] py-12 px-6 sm:px-16 lg:px-24 text-center">
          <h2 className="text-3xl font-semibold text-gray-800 mb-4">
            Our Products
          </h2>
          <p className="text-gray-900 mb-6">
            Explore our range of RCC Minars, Jalis, Marble Mimbers, and more.
          </p>
            ...
            {category.map((cat) => (
              ...
              >
                ...
                <button
                  ...
                  onClick={() => navigateProduct(cat.id)}
                >
                  Go To Product
                </button>
              </div>
        ...
        <div className="bg-[#19615D] text-white py-12 px-6 sm:px-16 lg:px-24 text-center">
          <h2 className="text-3xl font-semibold text-white mb-4">
            Why Choose Us
          </h2>
          <p className="text-white/80 mb-6">
            With over 40 years of experience, we ensure quality and excellence.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-8">
            <div className="flex flex-col items-center">
              <i className="fa-solid fa-award text-5xl text-[#F0E033] mb-4"></i>
              <h3 className="text-xl font-bold mb-2">Experience</h3>
              <p className="text-white/80">
                Over 4 decades in RCC construction.
              </p>
            </div>
            <div className="flex flex-col items-center">
              <i className="fa-solid fa-certificate text-5xl text-[#F0E033] mb-4"></i>
              <h3 className="text-xl font-bold mb-2">Quality</h3>
              <p className="text-white/80">
                High-quality, well-finished materials.
              </p>
            </div>
            <div className="flex flex-col items-center">
              <i className="fa-solid fa-clock text-5xl text-[#F0E033] mb-4"></i>
              <h3 className="text-xl font-bold mb-2">Timeliness</h3>
              <p className="text-white/80">Timely completion of projects.</p>
            </div>
          </div>
        </div>
      </main>
